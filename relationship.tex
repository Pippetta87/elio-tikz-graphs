...
\node[weak entity] (unphys) [above right=1cm and 2cm of calibration] {Incertezze fisica del modello} edge [<-] (ssm);


\node[entity] (corrections) [below right=3.5cm and 2cm of ssm] {Correzioni} edge [<-] (ssm);
  ...
  \draw[<-]  (sismobs.110)--(110:1) node[attribute] (freqs) {Frequenze oscillazioni adiabatiche} edge (sismobs);
