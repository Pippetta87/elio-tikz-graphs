...
%                                 shadow yshift=-.7ex}]
\tikzstyle{every weak entity}=[fill=black!50!white!100]

\tikzstyle{every attribute} = [top color=white, bottom color=yellow!20, draw=yellow, node distance=1cm, drop shadow,text width=1.5cm, opacity=0.5]
