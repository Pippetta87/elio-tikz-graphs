...
\node[draw,purple,fit=(hydro)(thermal)(opacity)(ssm)(unphys),ellipse,label={[purple,label distance=1cm]120:Oltre il Modello Solare standard}] (ssmapprox) at (hydro.west) {};
