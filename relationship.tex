...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[isa] (isa) [below=1cm of ssm] {\parbox{2cm}{Parametri fisici da determinare tramite confronto con osservazioni: efficenza trasporto convettivo, abbondanza di elio iniziale}} edge (ssm);
