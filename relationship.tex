...
\draw[link,<->] (surfaceobs.180) -- (unphys.170) node [sloped,pos=0.5, right] (stellaracc) {accuratezza};
\draw[link,<->] (sismobs.340) -- (unphys.20) node [sloped,pos=0.5, left] (sismacc) {accuratezza};
