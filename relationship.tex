...
\node[entity] (corrections) [below right=2.5cm and 1.5 of ssm] {Correzioni} edge [->] (ssm);
  ...
  \node[entity] (surfaceobs) [above=1cm of ssm] {Osservabili stellari} edge[->] (modelobs);
  \node[entity,anchor=north west] (sismobs) at (surfaceobs.south east) {Osservabili sismologiche} edge[->] (corrections);
