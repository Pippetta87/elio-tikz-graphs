...
\node[weak entity] (unphys) [above right=2cm and 2cm of calibration] {Incertezze fisica del modello} edge [<-] (ssm);


\node[entity] (corrections) [below right=3.5cm and 2.5cm of ssm] {Correzioni} edge [<-] (ssm);
  \node[entity] (modelobs) [below right=3.5cm and 1.5cm of ssm] {Discrepanze modello/osservazioni} edge [<-] (corrections);
  ...
  \draw[<-]  (sismobs.110)--(20:1) node[attribute] (freqs) {Frequenze oscillazioni adiabatiche} edge (sismobs);
