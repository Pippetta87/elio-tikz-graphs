...
\draw[link,->] (sismobs.15)--++(15:4cm) node[attribute] (heliumenv) {$Y_{ph}$};
\draw[link,->] (sismobs.355)--++(355:5cm) node[attribute] (soundspeed) {Velocit\'a del suono (isothermal): $c_s(r)/u(r)$};
