...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[entity] (stelparam) [below=2cm of opacity] {Parametri stellari} edge (modelobs);
  \node[entity] (sismobs) [right=2cm of stelparam] {Osservabili sismologiche} edge (modelobs);
