...
\draw[<-]  (sismobs.190)--++(190:2cm) node[attribute] (hydro) [above left=2cm and 1cm of ssm] {Equilibrio idrostatico} edge (ssm);
\draw[<-]  (sismobs.170)--++(170:2cm) node[attribute] (thermal) [below=of hydro] {Equilibrio termico locale} edge (ssm);
\draw[<-]  (ssm.180)--++(180:2cm) node[attribute] (opacity) [below=of thermal] {Equilibrio radiativo + criterio di Schwartzchild} edge (ssm);
...
\draw[<-]  (sismobs.20)--++(30:2cm) node[attribute] (freqs) {Frequenze oscillazioni adiabatiche} edge (sismobs);
