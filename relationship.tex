...
\node[entity] (corrections) [below =2cm ssm] {Discrepanze modello/osservazioni} edge [<-] (correction);
  \node[entity] (modelobs) [below right=3cm and 2cm of ssm] {Discrepanze modello/osservazioni} edge [<-] (correction);
