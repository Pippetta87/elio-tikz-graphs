...
\draw[<->]  (sismobs.20)--++(30:3cm) node[attribute] (freqs) {Frequenze oscillazioni adiabatiche};
\draw[<->] (sismobs.5)--++(5:2cm) node[attribute] (radiuscz) {Raggio fondo zona convettiva};
...
\node[draw,purple,fit=(hydro)(thermal)(opacity)(ssm),ellipse,label={[label distance=1cm]150[purple]:Modello Solare standard}] at (hydro.west) {};
