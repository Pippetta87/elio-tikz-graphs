...
\draw[link,->] (ssm.315)--++(315:2cm) node[entity, anchor=315+180] {Soluzione problema agli autovalori modi normali adiabatici};

\node[entity,anchor=north west] (neutrinoflux) at (sismobs.south east) {Flusso neutrini solari};

\draw[link,<->] (surfaceobs.50) -- (unphys.200) node [sloped,pos=0.5, anchor=south] (stellaracc) {accuratezza};
\draw[link,<->] (sismobs.60) -- (unphys.270) node [sloped,pos=0.5, anchor=south] (sismacc) {accuratezza};
