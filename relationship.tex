...
\draw[link,<->] (sismobs.260)--++(260:2cm) node[attribute] (MLT) {Modello convezione: MLT.};
\draw[link,<->] (unphys.280)--++(280:2cm) node[attribute] (modefreqsurf) {Influenza della zona superficiale sulle frequenze delle oscillazioni};
