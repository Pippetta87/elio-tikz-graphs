...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[relationship] (calibration) [below=1cm of ssm] {Calibrazione luminosit\'a e raggio} edge (ssm);

  \node[entity] (modelobs) [below right=3cm and 2cm of ssm] {Discrepanze modello/osservazioni} edge [<-] (ssm);
