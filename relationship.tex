...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[entity] (surfaceobs) [above right=1cm 2cm of ssm] {Parametri stellari} edge (modelobs);
  \node[entity] (sismobs) [below right=1cm 2cm of ssm] {Osservabili sismologiche} edge (modelobs);
